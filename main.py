...
async def read_root(gsheet_id: str, token: str = None):
    ...
    header = f"""
        ...
        %% This BibTeX file has been generated from Google Sheets using gsheet2bibtex
        %% Edit the original Google Sheets instead: https://docs.google.com/spreadsheets/d/{gsheet_id}

        """
    return header + generate_bibtex(gsheet_id)